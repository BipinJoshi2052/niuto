                      ...
                      >
                        <thead class="text-body">
                          <tr role="row">
                            <th
                              class="sorting"
                              tabindex="0"
                              aria-controls="productUnitTable"
                              rowspan="1"
                              colspan="1"
                              aria-sort="ascending"
                        ...
                        <tbody class="kt-table-tbody text-dark">
                          <tr
                            ...
                            role="row"
                            v-for="paymentMethod in paymentMethods1"
                            v-bind:key="paymentMethod.payment_method_id"
                            v-if="
                              paymentMethod.payment_method_id == 3 ||
                          ...
                          >
                            ...
                            <!-- <td>
                              {{
                                paymentMethod.payment_method_environment == "1"
                                  ? "Live"
                                  : "Sandbox"
                              }}
                            </td> -->
...
export default {
  ...
  methods: {
    ...
    addUpdatepaymentMethod() {
      this.$parent.loading = true;
      var url = "/api/admin/payment_method/" + this.paymentMethod.id+'?updateSetting=1';
