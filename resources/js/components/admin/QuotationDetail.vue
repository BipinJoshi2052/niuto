                                    ...
                                    <form>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6" v-if="quotation.type == 'purchase'">
                                                ...
                                                <fieldset class="form-group mb-3">
                                                    <select class=" js-states form-control bg-transparent">
                                                        <option value="">{{quotation.purchaser ? quotation.purchaser.purchaser_first_name + ' '+ quotation.purchaser.purchaser_last_name : ''}}</option>
                                                    </select>
                                                </fieldset>
                                            </div>
...
export default {
    ...
    methods: {
        ...
        fetchQuotation(id) {
            ...
            axios.get('/api/admin/quotation/' + id + '?getPurchaser=1&getCustomer=1&getWarehouse=1&productDetail=1&getProductCombinationDetail=1', this.token)
                .then(res => {
