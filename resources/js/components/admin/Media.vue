                ...
                <div class="card card-custom bg-transparent shadow-none border-0 mb-0">
                    <div class="card-header align-items-center  border-bottom-dark px-0">
                        <div class="card-title mb-0">
                            <h3 class="card-label mb-0 font-weight-bold text-body">Manage Gallery
                            </h3>
                        </div>
                ...
                <div id="generalgallary" class="gallary0 linked card card-custom gutter-b bg-white border-0">
                    <div class="card-header border-0 align-items-center">
                        <fieldset>
                            <div class="checkbox d-flex align-items-center">
                                <input type="checkbox" class="checkbox-input" id="checkbox1" @change="check($event)">
                                <label for="checkbox1"> Select All <small class="text-muted">({{ this.selectedImages.length   }} Item Selected)</small></label>
                                
                            </div>
                        </fieldset>
                        <div class="icons d-flex">

                            <button type="button" class="btn btn-danger p-2 ml-2" title="Delete" id="confirm-color" @click="deletegallary()">Delete</button>

                            <button type="button" title="Add New" class="btn btn-primary white p-2 ml-2" data-toggle="modal" data-target="#imagepopup" @click="toggleModal()">
                                Add New
                            </button>
                            <!--Basic Modal -->
                                ...
                                <div class="modal-dialog " role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <p>
                                                Click in the box for upload images (we accept JPG, PNG & GIF).
                                            </p>
                                            <div class="avatar-upload mb-3">
                                                ...
                                                <div class="avatar-preview">
                                                    <div id="imagePreview" class="rounded" >
                                                        <img :src="url" style="height: 194px;width: 100%;" />
                                                    </div>
                                                </div>
                                                <small class="form-text text-danger" v-if="errors.has('file')" v-text="errors.get('file')"></small>
                                            </div>
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="button" class="btn btn-primary ml-1" data-dismiss="modal" @click="addUpdategallary()">
                    ...
                    <div class="tab-content" id="v-pills-tabContent">
                        <div class="tab-pane fade show active" id="All-center" role="tabpanel" aria-labelledby="All-tab-center">
                            <div class="card-body">
                                <div class="row">
                                    <div v-for='gallary in gallaries' class="col-6 col-sm-4 col-md-3 col-lg-4  col-xl-3 loadingmore" style="display: block;" @click="setSelectedImages(gallary.id)">
                                        <div class="thumbnail text-center  mb-4" :class="{ 'active': selectedImages.includes(gallary.id)}">
                                            <div class="detail-link">
                                                <router-link :to='"/admin/media/"+gallary.id' class="btn btn-link d-flex justify-content-center align-items-center flex-column ">
...
export default {
    ...
    data() {
        return {
            ...
            token: [],
            selectedImages: [],
            supported_extension: ['jpg', 'jpeg', 'png', 'JPEG', 'PNG', 'JPG', 'gif', 'GIF'],
            file: [],
            gallary_tags:[],
            showModal: false,
            url:"/default.png",
    ...
    methods: {
        ...
        deletegallary() {
            ...
            if (confirm('Are You Sure?')) {
                this.$parent.loading = true;
                axios.delete(`/api/admin/gallary`, {
                        data: {
