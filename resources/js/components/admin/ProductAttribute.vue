                                ...
                                <div class="card-body">
                                    <div>
                                        <div class=" table-responsive" id="printableTable">
                                            ...
                                            <select name="productattributeTable_length" aria-controls="productattributeTable" class="" v-model="limit" v-on:change="fetchattributes()">
